...
namespace LyyneheymCore.SlyviaPile
{
    ...
    public sealed class Parser
    {
        ...
        public SyntaxTreeNode Parse()
        {
            ...
            this.Reset();
            // 获得原始节点的引用
            SyntaxTreeNode currentPtr = this.root;
            // 语法分析
            while ()
        ...
        private void Init()
        {
            ...
            // 流命中： <disjunct_pi> ::= ";"的Token
            // 语句命中： <disjunct_pi> ::= null
            //this.iMap.SetCellular(SyntaxType.case_disjunct_pi, TokenType.Token_Semicolon,
            //  new CandidateFunction(iProco, CFunctionType.deri___disjunct_pi__epsilon_37));
            // 流命中： <disjunct_pi> ::= "||"的Token
        ...
        private SyntaxTreeNode Kaguya()
        {
            ...
            if (this.istream[this.nextTokenPointer].aType == TokenType.Token_LeftBracket)
            {
                ...
                switch (mainToken.aType)
                {
                    case TokenType.Token_o_a:
                        ...
                        statementNode.paramDict["name"] = new SyntaxTreeNode(SyntaxType.para_name);
                        statementNode.paramDict["vid"] = new SyntaxTreeNode(SyntaxType.para_vid);
                        statementNode.paramDict["face"] = new SyntaxTreeNode(SyntaxType.para_face);
                        statementNode.paramDict["loc"] = new SyntaxTreeNode(SyntaxType.para_loc);
                        break;
                    case TokenType.Token_o_picture:
                        statementNode.nodeSyntaxType = SyntaxType.synr_picture;
                        statementNode.paramDict["id"] = new SyntaxTreeNode(SyntaxType.para_id);
                        statementNode.paramDict["filename"] = new SyntaxTreeNode(SyntaxType.para_filename);
                        statementNode.paramDict["x"] = new SyntaxTreeNode(SyntaxType.para_x);
                        statementNode.paramDict["y"] = new SyntaxTreeNode(SyntaxType.para_y);
                        statementNode.paramDict["capacity"] = new SyntaxTreeNode(SyntaxType.para_capacity);
                        statementNode.paramDict["xscale"] = new SyntaxTreeNode(SyntaxType.para_xscale);
                        statementNode.paramDict["yscale"] = new SyntaxTreeNode(SyntaxType.para_yscale);
                        statementNode.paramDict["ro"] = new SyntaxTreeNode(SyntaxType.para_ro);
                        break;
                    case TokenType.Token_o_move:
                        statementNode.nodeSyntaxType = SyntaxType.synr_move;
                        statementNode.paramDict["id"] = new SyntaxTreeNode(SyntaxType.para_id);
                        statementNode.paramDict["time"] = new SyntaxTreeNode(SyntaxType.para_time);
                        statementNode.paramDict["x"] = new SyntaxTreeNode(SyntaxType.para_x);
                        statementNode.paramDict["y"] = new SyntaxTreeNode(SyntaxType.para_y);
                        statementNode.paramDict["xacc"] = new SyntaxTreeNode(SyntaxType.para_xacc);
                        statementNode.paramDict["yacc"] = new SyntaxTreeNode(SyntaxType.para_yacc);
                        statementNode.paramDict["capacity"] = new SyntaxTreeNode(SyntaxType.para_capacity);
                        statementNode.paramDict["xscale"] = new SyntaxTreeNode(SyntaxType.para_xscale);
                        statementNode.paramDict["yscale"] = new SyntaxTreeNode(SyntaxType.para_yscale);
                        statementNode.paramDict["ro"] = new SyntaxTreeNode(SyntaxType.para_ro);
                    ...
                    case TokenType.Token_o_cstand:
                        ...
                        statementNode.paramDict["cstand"] = new SyntaxTreeNode(SyntaxType.synr_cstand);
                        statementNode.paramDict["id"] = new SyntaxTreeNode(SyntaxType.para_id);
                        statementNode.paramDict["name"] = new SyntaxTreeNode(SyntaxType.para_name);
                        statementNode.paramDict["face"] = new SyntaxTreeNode(SyntaxType.para_face);
                        statementNode.paramDict["x"] = new SyntaxTreeNode(SyntaxType.para_x);
                    ...
                    case TokenType.Token_o_se:
                        ...
                        statementNode.paramDict["filename"] = new SyntaxTreeNode(SyntaxType.para_filename);
                        statementNode.paramDict["vol"] = new SyntaxTreeNode(SyntaxType.para_vol);
                        break;
                    ...
                    case TokenType.Token_o_jump:
                        ...
                        statementNode.paramDict["name"] = new SyntaxTreeNode(SyntaxType.para_name);
                        statementNode.paramDict["cond"] = new SyntaxTreeNode(SyntaxType.para_cond);
                        break;
                    case TokenType.Token_o_for:
                        statementNode.nodeSyntaxType = SyntaxType.synr_for;
                        statementNode.paramDict["cond"] = new SyntaxTreeNode(SyntaxType.para_cond);
                        statementNode.paramDict["kotori"] = new SyntaxTreeNode(SyntaxType.case_kotori);
                        break;
                    ...
                    case TokenType.Token_o_scene:
                        ...
                        statementNode.paramDict["filename"] = new SyntaxTreeNode(SyntaxType.para_filename);
                        statementNode.paramDict["lable"] = new SyntaxTreeNode(SyntaxType.synr_lable);
                        break;
                    case TokenType.Token_o_switch:
                        statementNode.nodeSyntaxType = SyntaxType.synr_switch;
                        statementNode.paramDict["id"] = new SyntaxTreeNode(SyntaxType.para_id);
                        statementNode.paramDict["state"] = new SyntaxTreeNode(SyntaxType.para_state);
                        break;
                    case TokenType.Token_o_var:
                        statementNode.nodeSyntaxType = SyntaxType.synr_var;
                        statementNode.paramDict["dash"] = new SyntaxTreeNode(SyntaxType.para_dash);
                        break;
                    ...
                    case TokenType.Token_o_branch:
                        ...
                        statementNode.paramDict["link"] = new SyntaxTreeNode(SyntaxType.para_link);
                        break;
                    default:
                        break;
                }
                ...
                while (prescanPointer < this.istream.Count)
                {
                    ...
                    switch (this.istream[prescanPointer].aType)
                    {
                        case TokenType.Token_p_name:
                            ...
                            SyntaxTreeNode w_name = new SyntaxTreeNode(SyntaxType.case_wexpr);
                        ...
                        case TokenType.Token_p_vid:
                            ...
                            SyntaxTreeNode w_vid = new SyntaxTreeNode(SyntaxType.case_wexpr);
                        ...
                        case TokenType.Token_p_face:
                            ...
                            SyntaxTreeNode w_face = new SyntaxTreeNode(SyntaxType.case_wexpr);
                        ...
                        case TokenType.Token_p_id:
                            ...
                            SyntaxTreeNode w_id = new SyntaxTreeNode(SyntaxType.case_wexpr);
                        ...
                        case TokenType.Token_p_x:
                            ...
                            SyntaxTreeNode w_x = new SyntaxTreeNode(SyntaxType.case_wexpr);
                        ...
                        case TokenType.Token_p_y:
                            ...
                            SyntaxTreeNode w_y = new SyntaxTreeNode(SyntaxType.case_wexpr);
                        ...
                        case TokenType.Token_p_z:
                            ...
                            SyntaxTreeNode w_z = new SyntaxTreeNode(SyntaxType.case_wexpr);
                        ...
                        case TokenType.Token_p_xacc:
                            ...
                            SyntaxTreeNode w_xacc = new SyntaxTreeNode(SyntaxType.case_wexpr);
                        ...
                        case TokenType.Token_p_yacc:
                            ...
                            SyntaxTreeNode w_yacc = new SyntaxTreeNode(SyntaxType.case_wexpr);
                        ...
                        case TokenType.Token_p_capacity:
                            ...
                            SyntaxTreeNode w_capacity = new SyntaxTreeNode(SyntaxType.case_wexpr);
                        ...
                        case TokenType.Token_p_xscale:
                            ...
                            SyntaxTreeNode w_xscale = new SyntaxTreeNode(SyntaxType.case_wexpr);
                        ...
                        case TokenType.Token_p_yscale:
                            ...
                            SyntaxTreeNode w_yscale = new SyntaxTreeNode(SyntaxType.case_wexpr);
                        ...
                        case TokenType.Token_p_time:
                            ...
                            SyntaxTreeNode w_time = new SyntaxTreeNode(SyntaxType.case_wexpr);
                        ...
                        case TokenType.Token_p_filename:
                            ...
                            SyntaxTreeNode w_filename = new SyntaxTreeNode(SyntaxType.case_wexpr);
                        ...
                        case TokenType.Token_p_track:
                            ...
                            SyntaxTreeNode w_track = new SyntaxTreeNode(SyntaxType.case_wexpr);
                        ...
                        case TokenType.Token_p_cond:
                            ...
                            SyntaxTreeNode w_cond = new SyntaxTreeNode(SyntaxType.case_disjunct);
                        ...
                        case TokenType.Token_p_dash:
                            ...
                            SyntaxTreeNode w_dash = new SyntaxTreeNode(SyntaxType.case_disjunct);
                        ...
                        case TokenType.Token_p_state:
                            ...
                            SyntaxTreeNode w_state = new SyntaxTreeNode(SyntaxType.case_wexpr);
                        ...
                        case TokenType.Token_p_vol:
                            ...
                            SyntaxTreeNode w_vol = new SyntaxTreeNode(SyntaxType.case_wexpr);
                        ...
                        case TokenType.Token_p_loc:
                            ...
                            SyntaxTreeNode w_loc = new SyntaxTreeNode(SyntaxType.case_wexpr);
                        ...
                        case TokenType.Token_p_ro:
                            ...
                            SyntaxTreeNode w_ro = new SyntaxTreeNode(SyntaxType.case_wexpr);
                        ...
                        case TokenType.Token_p_link:
                            ...
                            SyntaxTreeNode w_link = new SyntaxTreeNode(SyntaxType.case_wexpr);
            ...
            // 如果是剧情文本的情况下
            else if (this.istream[this.nextTokenPointer].aType == TokenType.scenecluster)
            {
                // 把所有的剧情文本聚合成篇章
                SyntaxTreeNode statementNode = new SyntaxTreeNode();
                Token sc = new Token();
                sc.aType = TokenType.scenecluster;
                sc.aColumn = this.istream[this.nextTokenPointer].aColumn;
                sc.aLine = this.istream[this.nextTokenPointer].aLine;
                while (this.nextTokenPointer < this.istream.Count
                    && this.istream[this.nextTokenPointer].aType != TokenType.sceneterminator)
                {
                    // 如果匹配错误，就直接向上层抛错误
                    if (!this.istream[this.nextTokenPointer].aType.ToString().StartsWith("scene"))
                    {
                        return null;
                    }
                    sc.aTag = (sc.detail += this.istream[this.nextTokenPointer].detail);
                }
                // 把这个唯一token加到语法树上

...
namespace Yuri.YuriHalation.Command
{
    ...
    /// 命令类：显示背景
    /// </summary>
    internal class EditPictureCommand : HalationSingleEditCommand
    {
        /// <summary>
        /// 显示背景
        /// </summary>
        ...
        public EditPictureCommand(int line, int indent, RunnablePackage parent, string id, string filename, string x, string y, string xscale, string yscale, string opacity, string ro)

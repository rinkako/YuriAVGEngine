...
namespace Yuri.YuriHalation.Command
{
    ...
    /// 命令类：播放BGM
    /// </summary>
    class BGMCommand : IHalationSingleCommand
    {
        /// <summary>
        /// 播放BGM
        /// </summary>
        ...
        /// <param name="bgmName">BGM资源名</param>
        /// <param name="vol">音量</param>
        public BGMCommand(int line, int indent, RunnablePackage parent, string bgmName, string vol)
            : base(line, indent, parent)
        {
            HalaAttrList hal = new HalaAttrList();
            hal.Add(new KeyValuePair<string, KeyValuePair<ArgType, string>>("filename", new KeyValuePair<ArgType, string>(ArgType.Arg_filename, bgmName)));

...
namespace Yuri.YuriHalation.Command
{
    ...
    /// 命令类：状态变更
    /// </summary>
    internal class EditACommand : HalationSingleEditCommand
    {
        /// <summary>
        /// 变更状态
        /// </summary>
        ...
        public EditACommand(int line, int indent, RunnablePackage parent, string name, string face, string loc, string vid)

...
namespace Yuri.YuriHalation.Command
{
    ...
    /// 命令类：变量操作
    /// </summary>
    internal class EditVarCommand : HalationSingleEditCommand
    {
        /// <summary>
        /// 变量操作
        /// </summary>
        ...
        public EditVarCommand(int line, int indent, RunnablePackage parent, string operandLeft, string operateMode, string operandRight)
